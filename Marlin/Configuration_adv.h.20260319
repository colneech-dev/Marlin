...
// @section bltouch
  ...
  #define BLTOUCH_HS_MODE true
    ...
    #define BLTOUCH_HS_EXTRA_CLEARANCE    7 // (mm) Extra Z Clearance for BLTouch HS Mode
  #endif
...
#define ASSISTED_TRAMMING
  ...
  #define TRAMMING_POINT_XY { {  45, 55 }, { 210,  55 }, { 210, 200 }, { 45, 200 } }
...
// Use HIGH/LOW here (was INVERT_*_STEP_PIN true/false in older Marlin)
 ...
 * The Timeout can be overridden with M18 and M84. Set to 0 for No Timeout.
 */
...
#define BABYSTEPPING
  ...
  #define BABYSTEP_WITHOUT_HOMING             // Allow babystepping before homing
  #define BABYSTEP_ALWAYS_AVAILABLE           // Allow babystepping at all times during prints
 ...
 */
// LIN_ADVANCE — disabled for initial Sprite setup.
// The Sprite Pro's dual-drive gears give consistent extrusion without it.
// Enable and tune after all other calibration is complete.
// Starting K value for Sprite direct drive: 0.05
//#define LIN_ADVANCE
#if ENABLED(LIN_ADVANCE)
  //#define EXTRA_LIN_ADVANCE_K
  #define LIN_ADVANCE_K 0.05    // Starting point for Sprite direct drive (was 0.09 for Bowden)
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define PAUSE_PARK_RETRACT_FEEDRATE         60  // (mm/s) Initial retract feedrate — faster for direct drive
  #define PAUSE_PARK_RETRACT_LENGTH            2  // (mm) Initial retract — short for direct drive Sprite Pro
  #define FILAMENT_CHANGE_UNLOAD_FEEDRATE     20  // (mm/s) Unload feedrate — direct drive can go faster
  #define FILAMENT_CHANGE_UNLOAD_ACCEL        25  // (mm/s^2)
  #define FILAMENT_CHANGE_UNLOAD_LENGTH      100  // (mm) Full unload for Sprite Pro — enough to clear hotend + heatbreak
  #define FILAMENT_CHANGE_SLOW_LOAD_FEEDRATE   6  // (mm/s) Slow load speed
  #define FILAMENT_CHANGE_SLOW_LOAD_LENGTH     0  // (mm) 0 = skip slow load
  #define FILAMENT_CHANGE_FAST_LOAD_FEEDRATE  10  // (mm/s) Fast load feedrate
  #define FILAMENT_CHANGE_FAST_LOAD_ACCEL     25  // (mm/s^2)
  #define FILAMENT_CHANGE_FAST_LOAD_LENGTH    50  // (mm) Load length for Sprite Pro direct drive
